...
```
wget https://github.com/pepa65/eqr/releases/download/1.7.3/qr
wget https://github.com/pepa65/eqr/releases/download/1.7.3/promptpay
...
## Usage
```
qr 1.7.3 - Encode text into svg/png/jpg/terminal-format QR codes with optional logo
...
```
promptpay 1.7.3 - Make Thai PromptPay QR code
