...
```
wget https://github.com/pepa65/eqr/releases/download/1.8.23/qr
wget https://github.com/pepa65/eqr/releases/download/1.8.23/promptpay
...
## Usage
```
qr 1.8.23 - Encode text into svg/png/jpg/terminal-format QR codes with optional logo
...
```
promptpay 1.8.23 - Make Thai PromptPay QR code
