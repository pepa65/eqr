...
```
wget https://github.com/pepa65/eqr/releases/download/1.8.9/qr
wget https://github.com/pepa65/eqr/releases/download/1.8.9/promptpay
...
## Usage
```
qr 1.8.9 - Encode text into svg/png/jpg/terminal-format QR codes with optional logo
...
```
promptpay 1.8.9 - Make Thai PromptPay QR code
