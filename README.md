...
```
wget https://github.com/pepa65/eqr/releases/download/1.8.4/qr
wget https://github.com/pepa65/eqr/releases/download/1.8.4/promptpay
...
## Usage
```
qr 1.8.4 - Encode text into svg/png/jpg/terminal-format QR codes with optional logo
...
```
promptpay 1.8.4 - Make Thai PromptPay QR code
